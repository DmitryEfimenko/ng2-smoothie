...
import { Component, ElementRef, Input, HostListener, ChangeDetectionStrategy } from '@angular/core';
import { SmoothieChart } from 'smoothie';
import { SmoothieLine } from './smoothieLine';
export var Ng2SmoothieComponent = (function () {
    ...
    Ng2SmoothieComponent.prototype.addLineData = function (lineId, time, val) {
        ...
        if (!line) {
            ...
            var newLine = new SmoothieLine(lineIndex, opts);
            if (!this.isVisible) {
